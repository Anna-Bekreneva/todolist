...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsReducer(startState, todolistsActions.addTodoList({id: newId, todoList: newTodoList}));
...
test('all todolists should be set', () => {
    const endState: TodoListDomainType[] = todolistsReducer([], todolistsActions.setTodoLists({
        todoLists: [
